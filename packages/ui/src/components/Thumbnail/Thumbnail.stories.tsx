...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          '썸네일 이미지를 표시하는 컴포넌트입니다. aspectRatio로 비율을 제어하고, width/height로 크기를 조절할 수 있습니다.',
      },
    },
  },
  tags: ['autodocs'],
  argTypes: {
    ...
    width: {
      control: 'text',
      description:
        '이미지 너비 (Tailwind 클래스 또는 CSS 값). 미지정시 w-full 적용',
      table: {
        type: { summary: 'string' },
...
export const WidthBehaviorComparison: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'square vs auto aspectRatio 비교 - 동일한 이미지의 다른 비율 처리',
      },
    },
  },
};
